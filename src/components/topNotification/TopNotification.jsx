...
import { clearNotification, removeNotification } from "../../state/actions/notifications";
...
export const TopNotification = function () {
	...
	const handleSubmint = async () => {
		try {
			...
			let { data } = await axios.post(`${process.env.REACT_APP_BASE_URL}/website/v1/email-register`,{ email }, {
				headers: {
	...
	return notifications.length === 0 ? (
		...
		<div className="top-notification p-6">
			...
			<p className="top-notification-action" onClick={handleOpen}>
